        ...
        <div class="account-content text-gray-100 ml-4">
          <div class="input-field mt-4 px-2 py-1">
            ...
            <input
              ...
              type="text"
              class="bg-gray-50 border py-1 border-gray-300 text-blue-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          <div class="input-field mt-4 px-2 py-1">
            ...
            <input
              ...
              type="text"
              class="bg-gray-50 border border-gray-300 py-1 text-blue-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          <div class="input-field mt-4 px-2 py-1">
            <label for="Age"
