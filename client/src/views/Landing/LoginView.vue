        ...
        <div class="flex flex-col items-center justify-between xl:flex-row">
          <div class="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                Belum Punya Akun? <br class="hidden md:block" />
            </h2>    
            <router-link to="/register" aria-label="" class="text-white  hover:text-teal-accent-700">
          Ayo Daftar Disini!    <svg class="inline-block w-3 ml-2" fill="currentColor" viewBox="0 0 12 12">
              ...
              <div class="relative bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form class="bg-white" @submit="(e) => login(e) ">
                  <div class="mb-1 sm:mb-2 bg-white">
                    <label for="name" class="inline-block mb-1 font-medium bg-white ">Name</label>
                    <input 
                  ...
                  <div class="mb-1 sm:mb-2 bg-white">
                    <label for="email" class="inline-block mb-1 font-medium bg-white">password</label>
                    <input 
                  ...
                  <div class="mt-4 mb-2 sm:mb-4 bg-white">
                    <button 
                      ...
                      font-medium tracking-wide text-black transition duration-200 
